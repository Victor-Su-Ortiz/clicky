    ...
    var body: some View {
        ZStack {
            ...
            cursorShapeView
                ...
                .shadow(color: DS.Colors.clickyCursorGlowRed, radius: 8 + (buddyFlightScale - 1.0) * 20, x: 0, y: 0)
            ...
            // Blue spinner — shown while the AI is processing (transcription + MiniMax + waiting for TTS)
